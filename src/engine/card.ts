...
export class Card {
    ...
    static addGetCardTargetEventListener(eventCallback: EventListenerOrEventListenerObject) {
    ...
    clone(): Card {
      return new Card(this.name, this.flavorText, this.cardType, this.cost, this.landscapeType, this.ability);
    }
  }
  ...
  export class Creature extends Card {
    ...
    override clone(): Creature {
      return new Creature(this.name, this.flavorText, this.getCost(), this.landscapeType, this.ability, this.attack, this.defense);
    }
  ...
  export class Building extends Card {
    ...
    override clone(): Building {
      return new Building(this.name, this.flavorText, this.getCost(), this.landscapeType, this.ability);
    }
  ...
  export class Spell extends Card {
    ...
    override clone(): Spell {
      return new Spell(this.name, this.flavorText, this.getCost(), this.landscapeType, this.ability);
    }
