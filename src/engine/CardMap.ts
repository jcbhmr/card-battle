import { Card, Creature, Building, Spell, Landscape, LandscapeType, Ability, Targeter, PlayerTargeter, LaneTargeter, TargetType, Effect, BoardPos, Game, EffectDuration, EffectUpdateType } from "../model.ts";
...
put("Dark Angel", new Creature(
  ...
  put("Music Mallard", new Creature("Music Mallard", "", 1, LandscapeType.Candylands, new Ability("Activate >>> Draw a card. If this has 5 or more damage on it, draw 2.", new Targeter(PlayerTargeter.Self, LaneTargeter.None, false, 0, Targeter.ANY_PREDICATE, TargetType.EffectHolder), 
